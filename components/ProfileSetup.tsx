...
export const ProfileSetup: React.FC<Props> = ({ onComplete }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12 min-h-screen flex flex-col bg-black overflow-y-auto">
      {/* Header */}
      <div className="mb-12">
      ...
      <div className="flex-1 space-y-8">
        <div className="flex items-center gap-5 mb-6">
          <div className="w-14 h-14 bg-white/5 border border-white/5 rounded-3xl flex items-center justify-center">
            {steps[step].icon}
          </div>
          <div>
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="p-6 bg-emerald-400/5 border border-emerald-400/20 rounded-3xl">
              <h4 className="font-black italic uppercase text-emerald-400 mb-3 tracking-tighter">Meta Numérica</h4>
              <input
            ...
            <div className="p-6 bg-white/5 border border-white/5 rounded-3xl">
              ...
              <textarea
                className="w-full bg-black/40 border border-white/10 rounded-2xl p-4 text-sm text-white focus:border-emerald-400 outline-none min-h-[100px] italic resize-none"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-gray-600 mb-2">
                  Quantas vezes você treina no mesmo dia (1 = manhã, 2 = manhã + noite)
                </p>
                <select
                  ...
                  onChange={e => setProfile({
                    ...profile,
                    availability: { ...profile.availability, frequencyPerDay: parseInt(e.target.value) }
                  })}
                >
              ...
              <InputGroup
                ...
                onChange={v => setProfile({
                  ...
                  availability: {
                    ...profile.availability,
                    timePerSession: parseInt(v) || 60,
                    maxSessionTime: parseInt(v) || 60
                  }
                })}
              />

              {/* Mínimo de exercícios */}
              <InputGroup
                ...
                onChange={v => setProfile({
                  ...
                  availability: {
                    ...profile.availability,
                    minExercisesPerSession: parseInt(v) || 4,
                    minExercisesPerDay: parseInt(v) || 4
                  }
                })}
              />
                ...
                onKeyDown={e => {
                  if (e.key === 'Enter') {
                    ...
                    if (val) {
                      setProfile({
                        ...profile,
                        nutrition: { ...profile.nutrition, allergies: [...(profile.nutrition?.allergies || []), val] }
                      });
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {(profile.nutrition?.allergies || []).map(a => (
                  <button key={a}
                    onClick={() => setProfile({
                      ...profile,
                      nutrition: { ...profile.nutrition, allergies: profile.nutrition.allergies.filter(x => x !== a) }
                    })}
